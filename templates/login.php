...
<div class='container'>
    <div class='row justify-content-between'>
        ...
        <form class='form col-md-4' style="height:90%;margin-top:25vh" action="controleur.php">
            <p class='h5 text-dark text-center mt-3'>Connexion</p>
            <div class='form-group mt-4'>
                <label for='mail' id='labelMail' class='text-center'>Adresse mail</label>
                <input id='mail' name="email" class='form-control w-75' type="text" value=""/>
            </div>
            <div class='form-group'>
                <label for='pwd'>Mot de passe</label>
                <input id='pwd' name="mdp" class='form-control w-75' type="password" maxlength="20" value=""/>
            </div>
            <div class='form-group'>
                <label for='connected'><input type="checkbox"/></label>
                <span id='connected' style="font-size:70%" class="">Rester connecté</span>
            </div>
            <input class='btn btn-primary btn-block w-75 mt-4 mb-3 text-light bg-dark' type='submit' name="action"value='Se connecter' />
        </form>
