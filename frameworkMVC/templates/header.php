...
<nav class="navbar sticky-top navbar-dark bg-inverse navbar-expand-lg static-top pl-4 pr-2">
    <div style="width:15%">
    ...
    <div class="collapse navbar-collapse mb-auto" id="navbarResponsive">
        <ul class="navbar-nav mr-auto" id="listeBouton">
            ...
            <?php if (isset($_SESSION["connecte"]) && $_SESSION["connecte"] ) {
                ...
                if (isset($_GET['view']) && $_GET['view'] == 'myJewels') {
                    echo('active');
                }

                echo('">');
                   echo('<a class="nav-link text-light" href="index.php?view=myJewels">Mes Bijoux</a>
                </li>');
