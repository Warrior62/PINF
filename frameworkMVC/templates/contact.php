<title>Contact</title>
	...
	<div id="contenu" class="d-flex flex-row">
		<div id="formulaire" class="w-50">
			<form method="POST" action="./index.php?view=sendEmail">
				<br>
				<div class="form-group row">
				<label for="text" class="col-md-3 col-form-label">Nom :</label>
				<div class="col-md-9">
					<input type="text" class="form-control" id="text" name="nomContact" value="<?php if ($flag) echo($nomEtPrenom[0]['nom']) ?>">
				</div>
				</div>
				<br>
				<div class="form-group row">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" id="text" name="prenomContact" value="<?php if ($flag) echo($nomEtPrenom[0]['prenom']) ?>">
				</div>
				</div>
				<br>
				<div class="form-group row">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" id="text" name="mailContact" value="<?php if ($flag) echo($nomEtPrenom[0]['email'])?>">
				</div>
				</div>
				<br>
				<div class="form-group row">
