	...
	<div id="contenu" class="d-flex flex-row">
		<div id="formulaire" class="w-50">
			<form method="POST" action="./index.php?view=sendEmail">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" id="text" name="nomContact" value="<?= $nomEtPrenom[0] ?>">
				</div>
				</div>
				<br>
				<div class="form-group row">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" id="text" name="prenomContact" value="<?= $nomEtPrenom[1] ?>">
				</div>
				</div>
				<br>
				<div class="form-group row">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" id="text" name="mailContact" value="<?= $_SESSION['mail'] ?>">
				</div>
				</div>
				<br>
				<div class="form-group row">
