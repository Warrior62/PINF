...
<footer class="page-footer pt-5 text-center">
    <div class="bg-dark border-top pt-5 pb-5">
        ...
        <div class="pt-3">
            <a href="https://www.facebook.com/atelier.du.bijoutier/" target="_blank"><img src='pictures/facebook.svg' class='img-fluid pr-1' id='facebook-icon' style='max-width: 4.5%;height: auto' /></a>
