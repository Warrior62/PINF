	...
	<script>
		...
		{	
			$("#probleme").keyup(function()
			{
				...
				if($("#probleme").val().length < 256)
				{
					//console.log($("#probleme").val().length);
					$("#probleme").css({
						borderColor : 'grey',
					});
 	...
 	<div class="row justify-content-between">
	 	...
	 	<form action="controleur.php" method="GET">
	 		...
	 		<fieldset id="bijou">
	 					...
	 					<select class="form-control" name="idType" id="select_type">
	 					...
	 					<select class="form-control" name="idMatiere" id="select_matiere">
	 						<option selected value="-1">Veuillez sélectionner une option</option>
